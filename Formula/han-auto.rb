class HanAuto < Formula
  include Language::Python::Virtualenv

  desc "Markdown-to-HWP/HWPX public-document automation using Hancom Office fields"
  homepage "https://github.com/maenjh/han-auto"
  url "https://github.com/maenjh/han-auto/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "4dcf318697d3d1ff45ebb5ed9a3b97cb1a082a8964574cd48e1bde49787f2fae"
  head "https://github.com/maenjh/han-auto.git", branch: "master"
  ...
  def install
    ...
    # The MCP server entry point (han-auto-mcp) needs the optional 'mcp' extra,
    # which is not bundled in this formula. Don't expose a command that can't run;
    # see the README for installing the MCP server via pipx.
    (bin/"han-auto-mcp").unlink if (bin/"han-auto-mcp").exist?
  end

  test do
    assert_match "Usage", shell_output("#{bin}/han-auto --help")

    (testpath/"notice.md").write <<~MARKDOWN
      ---
      recipient: 수신자
      title: 제목
      ---
      ...
      본문 내용입니다.
    MARKDOWN
    assert_match "제목", shell_output("#{bin}/han-auto parse #{testpath}/notice.md")
  end
end
